// Kenya / Safaricom phone-number helpers.
//
...
/**
 * Validate + normalize an input as a Safaricom mobile number.
 * Returns the E.164 form on success, or an error message on failure.
 */
